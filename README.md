...
├── results_from_ppt/        # Small CSV files containing the values reported in the PPT/report
├── docs/
...
Large files are intentionally excluded from GitHub, including the dataset, extracted feature caches (`*.pt`), and locally generated result directories. These files can be regenerated by following the steps below.
